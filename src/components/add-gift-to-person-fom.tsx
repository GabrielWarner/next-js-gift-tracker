"use client";
import { GifIcon, CalendarIcon, PhotoIcon } from "@heroicons/react/24/outline";
import { Button } from "@/components/button";
import Link from "next/link";
import { addGiftToPersonWishlist } from "@/app/lib/actions";

export default function Form( { id }: { id: string } ) {

    //bind person id to function
    const addGiftToPersonWithID = addGiftToPersonWishlist.bind('null', id)
  return (
    <form action={addGiftToPersonWithID}>
